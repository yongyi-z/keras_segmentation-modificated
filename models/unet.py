...
def xception_unet(n_classes, input_height=416, input_width=608, encoder_level=3):

    model = _unet(n_classes, get_Xception_encoder,
                  input_height=input_height, input_width=input_width)
    model.model_name = "xception_unet"
    return model

def inception_v3_unet(n_classes, input_height=416, input_width=608, encoder_level=3):

    model = _unet(n_classes, get_Inceptionv3_encoder,
                  input_height=input_height, input_width=input_width)
    model.model_name = "inception_v3_unet"
    return model
